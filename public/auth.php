...
<head>
    ...
    <script src="./src/plugins/js-widgets/themedata.js"></script>
    <script src="./src/plugins/js-widgets/fontweight.js"></script>
    <script src="./src/plugins/js-widgets/widget.js"></script>
    <script src="./src/plugins/js-widgets/border.js"></script>
    <script src="./src/plugins/js-widgets/text_form_field.js"></script>
    ...
    <script src="./src/app_theme_data.js"></script>
    <script src="./src/auth/main.js"></script>
</head>
    <body>
    </body>
</html>